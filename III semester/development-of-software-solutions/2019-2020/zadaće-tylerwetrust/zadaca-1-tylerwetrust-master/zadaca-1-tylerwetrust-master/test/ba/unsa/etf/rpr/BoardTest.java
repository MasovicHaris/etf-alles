...
class BoardTest {
    ...
    @Test
        // position1 == null
    void illegalMoveNull() {
        Board b = new Board();

        assertThrows(
               IllegalArgumentException.class, () -> {b.move("A4", "D3"); }
        );
    }
    @Test
    // Kasparov vs Guy West 1977
    void game1() {
        Board b = new Board();
        try {
            b.move("E2", "E4");
    ...
    // Jacob Altusky vs Robert James Fischer 1954
    // Napomena: neka čudna vrsta igra te se zapravo ocekuje assertFalse na isCheck
    @Test
    void game2() {
        Board b = new Board();
        try {
        ...
        assertFalse(b.isCheck(ChessPiece.Color.WHITE));
