...
% TRANSPORT MATLAB code for transport.fig
...
%      applied to the GUI before transport_OpeningFcn gets called.  An
...
% Last Modified by GUIDE v2.5 03-Dec-2018 19:55:41
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
matricaCijena = str2num(get(handles.edit1,'string'));
izvorista = str2num(get(handles.edit2,'string'));
odredista = str2num(get(handles.edit3,'string'));
